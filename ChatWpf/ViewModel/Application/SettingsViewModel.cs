...
namespace ChatWpf.ViewModel.Application
{
    ...
    public class SettingsViewModel : BaseViewModel
    {
        ...
        {
            // Close settings menu
            DI.Di.ViewModelApplication.SettingsMenuVisible = true;
        }
        ...
        {
            // Close settings menu
            DI.Di.ViewModelApplication.SettingsMenuVisible = false;
        }
        ...
        public async Task LogoutAsync()
        {
            ...
            await RunCommandAsync(() => LoggingOut, async () =>
            {
                ...
                await DI.Di.ClientDataStore.ClearAllLoginCredentialsAsync();
        ...
        public async Task LoadAsync()
        {
            ...
            await RunCommandAsync(() => SettingsLoading, async () =>
            {
                ...
                var scopedClientDataStore = DI.Di.ClientDataStore;
        ...
        public async Task<bool> SavePasswordAsync()
        {
            ...
            return await RunCommandAsync(() => PasswordIsChanging, async () =>
            {
                ...
                var credentials = await DI.Di.ClientDataStore.GetLoginCredentialsAsync();
        ...
        private async Task<bool> UpdateUserCredentialsValueAsync(string displayName, Expression<Func<LoginCredentialsDataModel, string>> propertyToUpdate, string newValue, Action<UpdateUserProfileApiModel, string> setApiModel)
        {
            ...
            {
                // Log it
                FrameworkDI.Logger.LogDebugSource($"{displayName} is the same, ignoring");
            ...
            await DI.Di.ClientDataStore.SaveLoginCredentialsAsync(credentials);
